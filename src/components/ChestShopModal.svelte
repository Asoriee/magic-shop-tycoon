<script lang="ts">
    ...
    const CHESTS: ChestConfig[] = [
        ...
        },
        {
            ...
            desc: '5 ингредиентов + 1 зелье · Шанс золота и кэшбэка',
            crystalCost: 25,
            color: '#6c5ce7',
            accentColor: '#a29bfe',
            items: '6 предметов',
            ...
            chances: [
                ...
                { label: '20% Кэшбэк +5 💎', color: '#00cec9' }
            ]
        },
        {
            type: 'astral',
            name: 'Астральный ларец',
            desc: '10 ингредиентов + 1 редкое зелье · Золото и кэшбэк',
            crystalCost: 65,
            color: '#0984e3',
            accentColor: '#74b9ff',
            items: '11 предметов',
            ...
            chances: [
                ...
                { label: '35% Кэшбэк +15 💎', color: '#00cec9' }
            ]
        },
        {
            type: 'titan',
            name: 'Ларец Древних Титанов',
            desc: '16 ингредиентов + 2 зелья + Казна (1 час) + Кэшбэк + Шанс Фамильяра!',
            crystalCost: 140,
            color: '#c0392b',
            accentColor: '#f1c40f',
            items: '19+ наград',
            ...
            chances: [
                ...
                { label: '100% Кэшбэк +25 💎', color: '#00cec9' },
